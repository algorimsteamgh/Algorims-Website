...
- `design-options/ref-light-theme.png` is the **light homepage layout and palette reference**: centered statement hero, thin framed canvas and dividers, white ground, charcoal text, sparse deep violet, a single large system diagram, and a restrained proof strip.
- `design-options/ref-light-theme-1.png` is the **illustration style reference only**. Do not copy its split hero, card layout, black CTA, or headline treatment into the homepage.
